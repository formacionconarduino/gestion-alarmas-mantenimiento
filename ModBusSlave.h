...
CRC
 ...
 COMMENTS:
 	TEsta función calcula los dos bytes que forman el CRC del mensaje.
...
{
        Serial.begin(baud);
//*ESTE CODIGO MIRANDO EL MANUAL SE TIENE QUE QUEDAR REDUCIDO A LA NADA
//UCSR0C ES EL REGISTRO C DE LA USART0 Y UOM00, ETC DEBEN SER LOS BITS
        switch (parity) {
        case 'e': // 8E1
